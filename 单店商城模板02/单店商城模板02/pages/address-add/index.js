...
Page({
  ...
  bindSave: function(e) {
    ...
    wx.request({ 
      url: 'https://xcx.shty888.com/address.create ',
      // ?  token = ' + app.globalData.token + '& id =' + apiAddid 
      // + '& provinceId =' + commonCityData.cityData[this.data.selProvinceIndex].id + '& provinceName =' + 
      // commonCityData.cityData[this.data.selProvinceIndex].name 
      // + '& cityId =' + cityId + '& cityName =' + cityName
      // + '& districtId =' + districtId + '& districtName =' + districtName
      // + '& linkMan =' + linkMan + '& address =' + address
      // + '& mobile =' + mobile + '& code =' + code + '& isDefault =' + 'true' ,
      data: {
